...
void recebe(int sd){
    ...
    char* res;
    if(strcmp(msg, "Você está em uma casa desconhecida, à sua frente existem duas portas, a porta 1, e a porta 2. Em qual porta deseja entrar? \n(Digite 'porta 1' ou 'porta 2')") == 0){
